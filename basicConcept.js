...
let home = "Chattogram";
const email = "ebitleo77m@gamil.com";
home = "Dhaka";
...
let sum = a + b;
let subtraction = a - b;
let multiplicatin = a * b;
let division = a / b;
let mod = a * b;
console.log(sum, subtraction, multiplicatin, division, mod);
...
if (number1 < number2) {
  ...
  console.log("Number 2 is samller");
} else if (number1 == number2) {
  console.log("Number 1 and Number2 is equal");
} else if (number1 != number2) {
  console.log("Number 1 and Number2 is not equal");
} else if (number1 <= number2) {
  console.log("Number2 is equal or bigger than number1");
} else {
  console.log("Number1 is equal or bigger than number2");
}
...
if (value1 == value2 && value1 % 2 == 0) {
  console.log("Wow, both condition matched");
...
let arr = [22, 43, 6, 23, 67, 28, 99, 17, 94];
...
let array = [44, 77, 8, 3, 222, 44, 66, 88, 50, 22, 44];
...
let line = [33, 55, 75, 22, 444, 66, 88, 90, 123, 222, 98];
{
  for (let j of line) {
    if (j > 80) {
      console.log("Bigger than 80 is", j);
    }
  }
}
...
let count2 = 34;
let count3 = 44;
let values = multiple(count1, count2, count3);
console.log("Out put is", values);
